...
$quary1="SELECT * FROM book3 WHERE official='No' AND nationality='No'";
...
if(isset($_POST['submit'])){
  ...
  if($SU){
    echo "<script>window.location.replace('http://localhost:7878/project/Admin/View/online_international.php');</script>";
  }
}
?>