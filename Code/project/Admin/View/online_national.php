...
$quary1="SELECT * FROM book3 WHERE official='No' AND nationality='Yes'";
...
if(isset($_POST['submit'])){
  ...
  if($SU){
   echo "<script>window.location.replace('http://localhost:7878/project/Admin/View/online_national.php');</script>";
  }
}
?>