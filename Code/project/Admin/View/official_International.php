...
$quary1="SELECT * FROM book3 WHERE official='Yes' AND nationality='No'";
...
if(isset($_POST['submit'])){
  ...
  if($SU){
    echo "<script>window.location.replace('http://localhost:7878/project/Admin/View/official_International.php');</script>";
  }
}
?>