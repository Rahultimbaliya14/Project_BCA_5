...
$quary1="SELECT * FROM book3 WHERE status='Canceled'";
...
<body onload="cancel()">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="deletemodalLabel"><i class="fa-solid fa-ban"></i>Ticket Delete</h5>
        ...
        <div class="modal-footer">
          ...
          <input type="submit" class="btn btn-primary" name="submit" id="submit" value="Delete Ticket">
          </form>
        </div>
      </div>
    </div>
  ...
  ?>
  <h1 class="Title">Ticket Delete</h1>
  <div class="info">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="td"><button type="button" name="submit" class="delete btn btn-primary" data-bs-toggle="modal"
              data-bs-target="#deletemodal"><i class="fa-solid fa-circle-minus"></i>Delete </button></td>
        </tr>
        <?php
                      }
                    }
...
if(isset($_POST['submit'])){
  $no=$_POST['no'];
  $quaryup="DELETE FROM book3 WHERE ticketno=$no";
  $SU=mysqli_query($con,$quaryup);
  if($SU){
    echo "<script>window.location.replace('http://localhost:7878/project/Admin/View/canceled.php');</script>";
   }
}
?>